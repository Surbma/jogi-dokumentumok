...
- Fájl struktúra és elnevezések módosítása.
- Changelog különválasztása.
- Claude és Agent OS telepítése.
- Termék leírás létrehozása az Agent OS-szel a további AI munkákhoz.
